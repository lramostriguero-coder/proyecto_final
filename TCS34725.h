...
extern void TCS34725_setIntegrationTime(uint8_t it);
...
extern void TCS34725_getRGB(float *r, float *g, float *b);
extern void TCS34725_init(void);


extern void writeReg(uint8_t reg, uint8_t value);
extern void writeReg16Bit(uint8_t reg, uint16_t value);
extern uint8_t readReg(uint8_t reg);
extern uint16_t readReg16Bit(uint8_t reg);
