...
t h2 { color: #003366; border-bottom: 2px solid #003366; }
t .dato { font-size: 18px; margin: 10px 0; 
t         border-bottom: 1px dotted #ccc; padding: 5px; }
t .val { font-weight: bold; color: #0066cc; float: right; }
...
t <div class="dato">Estado: <span class="val">%m</span></div>
t <div class="dato">Temp: <span class="val">%t C</span></div>
t <div class="dato">Umbral: <span class="val">%u C</span></div>
t <div class="dato">RFID: <span class="val" style="color:black;">%i</span></div>
t <h3>Contadores</h3>
t <table width="100%">
t <tr><td align="center"><b class="g">VERDE</b></td>
t <td align="center"><b class="o">NARANJA</b></td></tr>
t <tr><td align="center"><h1>%v</h1></td>
t <td align="center"><h1>%n</h1></td></tr>
t </table>
c a 1 <div style="background-color:#ffc; padding:10px; border:1px solid orange;">
t <b>[CONFIG]</b><br>
t <form action="index.cgi" method="GET">
t Umbral: <input type="text" name="umb" value="%u">
